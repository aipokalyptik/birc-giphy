...
const requiredExamplesByReadme = {
    "random/README.md": [
        "/random integer",
        "/random integer int8 2",
        "/random integer uint8 2",
        "/random integer int16",
        "/random integer uint16",
        "/random integer int32",
        "/random integer uint32",
        "/random integer int64",
        "/random integer uint64",
        "/random integer int128",
        "/random integer uint128",
        "/random integer safeint",
        "/random float 2",
        "/random float float32 unit 2",
        "/random float float32 2",
        "/random float float32 finite 2",
        "/random float float32 normal 2",
        "/random float float32 subnormal 2",
        "/random float float32 special 3",
        "/random float float32 all 2",
        "/random float float64 unit 2",
        "/random float float64 2",
        "/random float float64 finite 2",
        "/random float float64 normal 2",
        "/random float float64 subnormal 2",
        "/random float float64 special 3",
        "/random float float64 all 2",
        "/random boolean 3",
        ...
        "/random shuffle",
        "/random dice",
        "/random dice 1d9007199254740991",
        "/random ip v4",
        "/random ip v6",
        "/random mac 2",
        "/random timestamp",
        "/random timestamp unix32",
        "/random timestamp 2020",
