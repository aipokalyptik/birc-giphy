...
A transcript-aware bIRC adaptation of [Solarized Dark](https://github.com/altercation/vim-colors-solarized).

![bIRC transcript preview of Solarized Dark](preview.svg)
...
| --- | --- | --- |
| Canvas | Normal/editor background | `#002b36` |
...
| Cards and reaction surfaces | Secondary editor surface | `#073642` |
...
- Palette evidence: `colors/solarized.vim; dark palette`
