...
A transcript-aware bIRC adaptation of [Monokai](https://github.com/crusoexia/vim-monokai).

![bIRC transcript preview of Monokai](preview.svg)
...
| Mention background | Search/Visual/selection | `#49483e` |
| Cards and reaction surfaces | Secondary editor surface | `#3e3d32` |
...
- Palette evidence: `colors/monokai.vim palette`
