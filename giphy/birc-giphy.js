 ...
 *
 * Script ID: com.github.aipokalyptik.birc-utils.giphy
...
(function registerBircGiphyScript() {
    ...
    var SCRIPT_ID = "com.github.aipokalyptik.birc-utils.giphy";
    var SCRIPT_VERSION = "1.0.0";
    var SCRIPT_UPDATE_PAGE_URL =
        "https://github.com/aipokalyptik/birc-utils/tree/main/giphy";
    var SCRIPT_UPDATE_FILE_URL =
        "https://github.com/aipokalyptik/birc-utils/blob/main/giphy/birc-giphy.js";
    var SCRIPT_RELEASE_TAG_PREFIX = "birc-utils-giphy-v";
    var SCRIPT_COMPARE_URL_PREFIX =
        "https://github.com/aipokalyptik/birc-utils/compare/";
    var SCRIPT_FILE_DIFF_ANCHOR =
        "#diff-34d80f207cd572985e9cee56ad90303ba6e78a994c3ee914178b2e6cbd917ca9";
    ...
    function checkForScriptUpdate() {
        ...
        birc.fetch(UPDATE_MANIFEST_URL).then(function handleUpdateResponse(response) {
            ...
            console.info("GIPHY update check was not completed", error);
        });
    }
    ...
    function reportAvailableScriptUpdate(latestVersion) {
        ...
        birc.print(
            "[GIPHY] Update available for " + SCRIPT_ID + ": installed " +
            SCRIPT_VERSION + ", current " + latestVersion + "."
        );
        birc.print("[GIPHY] Canonical update file: " + SCRIPT_UPDATE_FILE_URL);
        birc.print(
            "[GIPHY] Changes since the installed version: " + comparisonUrl +
            " (opens at giphy/birc-giphy.js)."
        );
        birc.print(
            "[GIPHY] Update instructions: open that URL, review the file, " +
